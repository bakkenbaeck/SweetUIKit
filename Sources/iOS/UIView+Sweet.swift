...
public extension UIView {
    ...
    func fillSuperview(with insets: UIEdgeInsets = UIEdgeInsets.zero) {
    ...
    func attachToTop(viewController: UIViewController? = nil) {
        guard let superview = self.superview else { return }
    ...
    class func instanceFromNib<T: UIView>(nibName: String? = nil, bundle: Bundle = .main, owner: Any? = nil, options: [UINib.OptionsKey: Any]? = nil) -> T? {

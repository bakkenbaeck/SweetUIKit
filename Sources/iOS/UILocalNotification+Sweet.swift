...
public extension UILocalNotification {
    ...
    static func schedule(_ id: String, at date: Date, soundName: String? = nil, message: String, actionTitle: String? = nil) {
    ...
    static func find(_ id: String) -> UILocalNotification? {
